import { Engineer, Assignment } from '../models/index.js';
...
export const getEngineerById = async (req, res) => {
  try {
    ...
    const assignments = await Assignment.findByEngineer(engineer._id, 'active');
...
export const getEngineerCapacity = async (req, res) => {
  try {
    ...
    const assignments = await Assignment.findByEngineer(engineer._id)
...
export const getEngineerAssignments = async (req, res) => {
  try {
    const { status } = req.query;

    const assignments = await Assignment.findByEngineer(req.params.id, status);
...
export const searchEngineersBySkill = async (req, res) => {
  try {
    ...
    let engineers = await Engineer.findBySkill(skill, level);
